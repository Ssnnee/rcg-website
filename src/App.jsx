    ...
    <>
      ...
      <section id='accueil' className="container mx-auto p-4 min-h-[30rem] flex flex-col md:flex-row justify-center items-center border border-gray-200 rounded">
        ...
        <figure className='h-44 sm:h-52 overflow-hidden md:hidden mb-10' >
          <a href={book} >
            <img src={book} alt="placeholder" title='Revue Congolaise de Gestion' className="md:hidden xl:h-80 relative" />
          </a>
        </figure>
        ...
        <figure className='w-full md:w-2/3 flex justify-center relative mb-2' >
          <a href={book} >
            <img src={book} alt="placeholder" title='Revue Congolaise de Gestion' className="hidden md:block xl:h-80 relative" />
          </a>
        </figure>
      </section>
      ...
      <section id='ensavoirplus' className="container mx-auto my-4 p-4 min-h-[20vh] flex items-center flex-col border border-gray-200 rounded">
