...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between mb-h">
      ...
      <section id='comitédelecture' className="container mx-auto min-h-[100vh] px-6 py-12 mt-6 flex justify-center items-start flex-col border border-gray-200 rounded">
